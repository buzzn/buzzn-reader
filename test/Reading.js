...
describe('Reading', () => {
    ...
    it('does pars a easymeter ESY5Q3DA1004 V3.02', () => {
        let reading = new Reading(
            ...
            1-0:41.7.255*255(-000114.00*W)\n\
            1-0:61.7.255*255(000000.00*W)\n\
            1-0:1.7.255*255(-000114.00*W)\n\
            1-0:96.5.5*255(D2)\n\
        ...
        expect(reading.meterSerialnumber).to.equal('1003003416')
        expect(reading.energyAMilliwattHour).to.equal(900000)
        expect(reading.energyBMilliwattHour).to.equal(null)
        expect(reading.powerAMilliwatt).to.equal(114000)
    ...
    it('does pars a easymeter ESY5Q3DA1004 V3.04', () => {
